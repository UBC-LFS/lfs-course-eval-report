...
const { metaProcess, statsForEverySection, dataForScatter, dataForKPI, dataForDepartmentRanking } = require('./util/process')
...
readDB('aggregatedData')
  .then(data => {
    ...
    puids.forEach(puid => {
      ...
      const departmentStats = dataForDepartmentRanking(data, kpiData)
