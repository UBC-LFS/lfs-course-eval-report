...
describe('sumAllUMICounts', () => {
  it('takes an array of arrays of UMI1-6 counts and returns the sum of the counts', () => {
    let input = [
      [
        { 1: 1, 2: 1, 3: 1, 4: 1, 5: 1 },
        { 1: 1, 2: 1, 3: 1, 4: 1, 5: 1 },
    ...
    let output = {
      UMI1: { '1': 1, '2': 1, '3': 1, '4': 1, '5': 1 },
      UMI2: { '1': 1, '2': 1, '3': 1, '4': 1, '5': 1 },
      UMI3: { '1': 1, '2': 1, '3': 1, '4': 1, '5': 1 },
      UMI4: { '1': 1, '2': 1, '3': 1, '4': 1, '5': 1 },
      UMI5: { '1': 1, '2': 1, '3': 1, '4': 1, '5': 1 },
      UMI6: { '1': 1, '2': 1, '3': 1, '4': 1, '5': 1 }
    }
    assert.deepEqual(u.sumAllUMICounts(input), output)
    ...
    output = {
      UMI1: { '1': 2, '2': 2, '3': 2, '4': 2, '5': 2 },
      UMI2: { '1': 2, '2': 2, '3': 2, '4': 2, '5': 2 },
      UMI3: { '1': 2, '2': 2, '3': 2, '4': 2, '5': 2 },
      UMI4: { '1': 2, '2': 2, '3': 2, '4': 2, '5': 2 },
      UMI5: { '1': 2, '2': 2, '3': 2, '4': 2, '5': 2 },
      UMI6: { '1': 2, '2': 2, '3': 2, '4': 2, '5': 4 }
    }
    assert.deepEqual(u.sumAllUMICounts(input), output)
